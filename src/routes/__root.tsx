...
// import { PromoTicker } from "../components/site/PromoTicker"; // Removed
  ...
  createRootRouteWithContext<{ queryClient: QueryClient }>()({
    head: () => ({
      meta: [
        ...
        {
          title:
            "Astrotring — Premium Vedic Astrology & Kundli Consultations",
        },
        {
          name: "description",
          content:
        ...
        },
        {
          ...
          content:
            "Talk to trusted astrologers, get your free Janam Kundli, and discover what the stars have written for you.",
        },
